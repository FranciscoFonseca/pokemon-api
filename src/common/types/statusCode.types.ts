export enum StatusCodeClientErrorEnum {
...
export enum StatusCodeInfoEnum {
  InfoContinue = 100,
  InfoProcessing = 102,
  InfoSwitchingProtocols = 101,
}

export enum StatusCodeRedirectEnum {
  RedirectFound = 302,
...
export enum StatusCodeServerError {
...
export enum StatusCodeSucessEnum {
  SuccessAccepted = 202,
